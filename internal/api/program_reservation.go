...
//
// 書き込み側（program_intents / program_overrides）は M3-1（issue #29）で既に
// (site, programId) に寄せていた。reservations もこの複合キーを主キーに持つので、
// 予約行が再実体化されてもこのエンドポイントの URL は変わらない（CLAUDE.md
