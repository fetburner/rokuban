...
WHERE r.site = $1
  ...
  AND r.program_start_at < sqlc.arg(window_end)::timestamptz
  AND r.program_start_at + (r.program_duration_ms * interval '1 millisecond') > sqlc.arg(window_start)::timestamptz
