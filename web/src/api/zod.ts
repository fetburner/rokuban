...
export const ListRulesResponseItem = zod.object({
  ...
  "priority": zod.int().default(listRulesResponseOnePriorityDefault),
  ...
  "genres": zod.array(zod.int().min(listRulesResponseOneGenresItemMin).max(listRulesResponseOneGenresItemMax)).optional().describe('genre lv1'),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(listRulesResponseOneTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const CreateRuleBody = zod.object({
  ...
  "priority": zod.int().default(createRuleBodyPriorityDefault),
  "isFree": zod.boolean().nullish().describe('null = 問わない'),
  "durationMinMs": zod.int().nullish(),
  "durationMaxMs": zod.int().nullish(),
  "periodStartAt": zod.iso.datetime({"offset":true}).nullish(),
  ...
  "channelTypes": zod.array(zod.enum(['GR', 'BS', 'CS', 'SKY'])).optional(),
  "genres": zod.array(zod.int().min(createRuleBodyGenresItemMin).max(createRuleBodyGenresItemMax)).optional().describe('genre lv1'),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(createRuleBodyTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const CreateRuleResponse = zod.object({
  ...
  "priority": zod.int().default(createRuleResponseOnePriorityDefault),
  "isFree": zod.boolean().nullish().describe('null = 問わない'),
  "durationMinMs": zod.int().nullish(),
  "durationMaxMs": zod.int().nullish(),
  "periodStartAt": zod.iso.datetime({"offset":true}).nullish(),
  ...
  "channelTypes": zod.array(zod.enum(['GR', 'BS', 'CS', 'SKY'])).optional(),
  "genres": zod.array(zod.int().min(createRuleResponseOneGenresItemMin).max(createRuleResponseOneGenresItemMax)).optional().describe('genre lv1'),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(createRuleResponseOneTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const GetRuleResponse = zod.object({
  ...
  "priority": zod.int().default(getRuleResponseOnePriorityDefault),
  "isFree": zod.boolean().nullish().describe('null = 問わない'),
  "durationMinMs": zod.int().nullish(),
  "durationMaxMs": zod.int().nullish(),
  "periodStartAt": zod.iso.datetime({"offset":true}).nullish(),
  ...
  "channelTypes": zod.array(zod.enum(['GR', 'BS', 'CS', 'SKY'])).optional(),
  "genres": zod.array(zod.int().min(getRuleResponseOneGenresItemMin).max(getRuleResponseOneGenresItemMax)).optional().describe('genre lv1'),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(getRuleResponseOneTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const UpdateRuleBody = zod.object({
  ...
  "priority": zod.int().default(updateRuleBodyPriorityDefault),
  "isFree": zod.boolean().nullish().describe('null = 問わない'),
  "durationMinMs": zod.int().nullish(),
  "durationMaxMs": zod.int().nullish(),
  "periodStartAt": zod.iso.datetime({"offset":true}).nullish(),
  ...
  "channelTypes": zod.array(zod.enum(['GR', 'BS', 'CS', 'SKY'])).optional(),
  "genres": zod.array(zod.int().min(updateRuleBodyGenresItemMin).max(updateRuleBodyGenresItemMax)).optional().describe('genre lv1'),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(updateRuleBodyTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const UpdateRuleResponse = zod.object({
  ...
  "priority": zod.int().default(updateRuleResponseOnePriorityDefault),
  "isFree": zod.boolean().nullish().describe('null = 問わない'),
  "durationMinMs": zod.int().nullish(),
  "durationMaxMs": zod.int().nullish(),
  "periodStartAt": zod.iso.datetime({"offset":true}).nullish(),
  ...
  "channelTypes": zod.array(zod.enum(['GR', 'BS', 'CS', 'SKY'])).optional(),
  "genres": zod.array(zod.int().min(updateRuleResponseOneGenresItemMin).max(updateRuleResponseOneGenresItemMax)).optional().describe('genre lv1'),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(updateRuleResponseOneTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const DeleteRuleResponse = zod.object({
  "id": zod.int(),
  "deletedReservations": zod.int().describe('overrides なしで削除した rule 予約の件数'),
  "detachedReservations": zod.int().describe('overrides 付きで detached 化した件数')
})
...
export const SearchProgramsBody = zod.object({
  ...
  "channelTypes": zod.array(zod.enum(['GR', 'BS', 'CS', 'SKY'])).optional(),
  "genres": zod.array(zod.int().min(searchProgramsBodyGenresItemMin).max(searchProgramsBodyGenresItemMax)).optional(),
  "times": zod.array(zod.object({
  "weekdays": zod.int().min(1).max(searchProgramsBodyTimesItemWeekdaysMax).describe('bit0=月 … bit6=日'),
...
export const GetProgramResponse = zod.object({
  ...
  "lv1": zod.int(),
  "lv2": zod.int(),
  "un1": zod.int().optional(),
  "un2": zod.int().optional()
})).optional(),
  "video": zod.object({
  "type": zod.string().optional(),
  "resolution": zod.string().optional(),
  "streamContent": zod.int().optional(),
  "componentType": zod.int().optional()
}).optional(),
  "audios": zod.array(zod.object({
  "componentType": zod.int(),
  "isMain": zod.boolean(),
  "samplingRate": zod.int(),
...
export const ListRecordingsQueryParams = zod.object({
  ...
  "limit": zod.int().min(1).max(listRecordingsQueryLimitMax).default(listRecordingsQueryLimitDefault),
  "before": zod.iso.datetime({"offset":true}).optional().describe('キーセットカーソル。前ページ最後の要素の startAt。beforeId と対で使う'),
  "beforeId": zod.int().optional().describe('キーセットカーソル。前ページ最後の要素の id。before と対で使う')
})
...
export const ListRecordingDropStatsResponseItem = zod.object({
  ...
  "elapsedMs": zod.int().nullish().describe('録画開始からの経過ミリ秒。PCR を得られない場合は省略')
...
export const ListCircuitBreakersResponseItem = zod.object({
  ...
  "detail": zod.object({
  "total": zod.int().describe('止めた削除の総数。'),
