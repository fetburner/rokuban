...
// だが、Dialog の実装は Radix ではなく `@base-ui/react/dialog` に合わせている。
// `DialogPrimitive.Popup` に `initialFocus` / `finalFocus` を渡せる点を含め、
// base-ui の部品名と Props をそのまま使う。再取得する場合はこの差分を復元すること。
